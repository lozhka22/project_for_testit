...
exports.config = {
    ...
    // specFileRetriesDeferred: false, s
    //
    ...
    cucumberOpts: {
        default: ['-f ./testitFormatter.js'],
        profile: ['-f ./testitFormatter.js'],
        // <string[]> (file/dir) require files before executing features
        require: ['./features/step-definitions/steps.js', './testitFormatter.js'],
        // <boolean> show full backtrace for errors
        backtrace: false,
        // <string[]> ("extension:module") require files with the given EXTENSION after requiring MODULE (repeatable)
        requireModule: ['testit-api-client','testit-adapter-cucumber'],
